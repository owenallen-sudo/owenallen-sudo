...
# My main projects
1. owenallen-sudo/ish for catching bugs and vulnerabilities in global application iSH and patching them (I plan on it being my most active project for quite some time).
...
3. I have other projects but I don't pay as much attention to them any longer since I don't need them any longer and there are better alternatives for them such as iwmenu compared to my iwdwifi.

# About me
I'm an open-source software developer (I am best at low level stuff, architecture security, I suck at remembering syntax and high-level languages) who works on projects such as owenallen-sudo/ish to fix bugs in ish and owenallen-sudo/multi-downloader for downloading software. I am also very interested in plan9's namespaces, seL4 and LionsOS (especially regarding it's fast IPC communication, and lock free deisgn) and beOS (and haiku) extended attributes and multithreading architecture but have never actually tried any of them.
